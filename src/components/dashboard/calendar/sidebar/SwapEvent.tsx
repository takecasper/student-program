...
export const SwapEvent = ({ totalWeekData }: EventSliderProps) => {
  const { setSlideState, setSelectedSwapEvent } = useCalendarContext();
          ...
          return (
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  setSelectedSwapEvent(item);
                  setSlideState(SlideStates.SWAP_REQUEST_A);
                }}
              >
                <Plus size={16} />
              </button>
