...
export default function VideoInterviewRight({}: VideoInterviewRightProps) {
  return (
    <div className=" bg-white space-y-6 text-gray-800 shrink-0 pt-[60px] pr-20">
      <h1 className="text-[12px] font-semibold">System requirements Check</h1>
      ...
      <div className="space-y-6">
        ...
        <div className="relative">
          <div className="flex gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-[12px] font-medium">Step 1: Review Test Tips</h3>
              <p className="text-[12px] text-gray-600">
        ...
        <div className="relative">
          <div className="flex gap-4">
            ...
            <div className="space-y-2">
              <h3 className="text-[12px] font-medium">Step 2: System Requirement Check</h3>
              <p className="text-[12px] text-gray-600">
              ...
              <Link
                href="/snapshot-test"
                className="px-6 py-2 text-[#364699] text-[12px] border border-[#364699] rounded-full hover:bg-gray-50"
              >
                System Check
              </Link>
            </div>
        ...
        <div className="relative">
          <div className="flex gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-[12px] font-medium">Step 3: Start Casper Practice Test</h3>
              <p className="text-[12px] text-gray-600">
