      ...
      <div className="w-full md:w-1/2 bg-white p-8 flex flex-col items-center justify-center rounded-r-2xl">
          ...
          <form onSubmit={handleSubmit0} className="w-full max-w-md space-y-4 mb-8 mt-[59px]">
            ...
            <div className='flex gap-4 mt-9'>
              ...
              <div className='inline-block'>
                <p className='text-sm font-bold'>Your location will no longer be able to be changed after this point.</p>
                <p className='text-xs mt-2'>Changing your location may affect where your data is stored. It will ot affect the availability of programs or schools, or admissions eligibility.</p>
              </div>
            </div>

            {/* Privacy Policy Link */}
            <div className="text-sm text-[#333333] border-t border-[#33333399] text-center w-full pt-4 mt-[59px]">
              For more information on data residency, please access our<br />
        ...
        {step == 2 &&
          <div className="w-full max-w-md space-y-4 mb-8 mt-[59px]">
            ...
            <div className='text-xs text-[#33333399] font-[500] mb-[39px] mt-6'>Please check your email and follow the enclosed link to confirm your email address and proceed with regristration</div>
            {/* Resend Email Link */}
            <div className="text-xs text-[#33333399] w-full leading-5">
              Don&apos;t forget to check your <b>SPAM</b> folder, just in case.<br />
          ...
          <form onSubmit={handleSubmit3} className="w-full max-w-md space-y-4 mb-8 mt-[59px]">
            ...
            <div>
              <label className="flex text-sm font-medium text-gray-700 mb-1 items-center gap-1">
                Location
                <span title="We auto-detect your location" className="text-gray-400 cursor-help text-xs"><CircleAlert size={12} /></span>
              </label>
              ...
              <>
                <div className="p-6 rounded-md text-center m-auto max-w-sm">
                  ...
                  <p className="text-sm text-gray-700">
                    Your account details are pending a manual verification against the government ID you submitted. This normally takes <span className="font-medium">1–2 business days</span> and we will notify you when we complete our review by email.
                  </p>
                </div>
                <div className='w-full flex justify-center mt-[48px] items-center'>
                  <button
                ...
                <div className="max-w-sm w-full text-center m-auto">
                  ...
                  <div className="bg-white p-4 rounded-md border max-h-48 overflow-y-auto text-left">
                    ...
                    <p className="text-sm text-gray-700">
                      ...
                      vulputate justo, vitae rutrum lorem. Nullam eget eros lorem. Morbi
                      velit mi, viverra ut consectetur vel, maximus sed arcu. Suspendisse
                      ullamcorper, magna vel congue porttitor, quam nisi ultricies turpis,
                      non lacinia enim lacus sit amet eros. Aliquam dignissim enim enim,
                      vitae malesuada odio sodales vel. Proin lobortis mollis consectetur.
                      Vivamus venenatis tellus sit amet rhoncus mattis. Ut et est ornare,
                      rhoncus arcu tincidunt, Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin et
                      vulputate justo, vitae rutrum lorem. Nullam eget eros lorem. Morbi
                      velit mi, viverra ut consectetur vel, maximus sed arcu. Suspendisse
                      ullamcorper, magna vel congue porttitor, quam nisi ultricies turpis,
                      non lacinia enim lacus sit amet eros. Aliquam dignissim enim enim,
