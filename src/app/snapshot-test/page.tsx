...
export default function SnapshotTestPage() {
  ...
  const [currentStep, setCurrentStep] = useState<
    'intro' | 'initial' | 'video' | 'thinking' | 'recording' | 'review'
  >('intro');
  ...
  return (
    // Intro screen
    currentStep === 'intro' ? (
      <div className="min-h-screen flex flex-col bg-[#fafbfc] items-center justify-center">
        <div className="w-[480px] bg-white rounded-lg shadow p-8 flex flex-col items-center">
          <Image src="/acuity.png" alt="Logo" width={80} height={80} className="mb-4" />
          <h1 className="text-4xl font-bold text-[#364699] mb-2 text-center">WELCOME!</h1>
        ...
        <button
          className="mt-10 px-8 py-2 rounded-full bg-[#364699] text-white font-semibold transition hover:bg-[#2a3a7a]"
